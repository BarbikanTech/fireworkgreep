...
<body itemscope itemtype="http://schema.org/WebPage">
                            ...
                            while ($productrow = $productResult->fetch_assoc()) {
                                ...
                                <div class="col-lg-2 col-md-3 col-6 product_row ">
                                    <div class="prodct-card text-center">
                                        ...
                                        <a class="text-center pb-2" type="button" data-bs-toggle="modal"
                                            data-bs-target="#productmodal_<?php echo $productrow["id"]; ?>">
                                        ...
                                        <div class="prdct-price">
                                            ...
                                            <span
                                                class="strikes"><?php if ($productrow["discount_lock"] == 0) {
                                                    echo $productrow["price"];
                                                } ?></span>
                                            <span
                                                class="price"><?php if ($discount_lock != null && $discount_lock != "null" && $discount_lock == 0) {
                                                    echo ($productrow["price"] - ($productrow["price"] * $categoryDiscount / 100));
                                                } else {
                                                    echo $productrow["price"];
                                                } ?></span>
                                        </div>
                                        <div class="amount" style="margin-left: 44px;"> <input type="text" name="amount"
                                                class="form-control rate_box price-box amount_<?php echo $productrow["id"]; ?>"
                                                placeholder="Price" disabled>
                                        </div>
                                        <div class="prdct-qty ">
                                            <span class="minus">-</span>
                                            <input type="text" name="quantity"
                                                class="form-control qty_box prdct-box quantity_<?php echo $productrow["id"]; ?>"
                                                placeholder="Qty" onFocus="Javascript:CalProductAmount(this);"
                                                onBlur="Javascript:CalProductAmount(this);" onKeyup="Javascript:CalProductAmount(this);"
    ...
    <div class="fixed point2">
        <div class="nav-trigger smallbutton btncart" data-bs-toggle="offcanvas" data-bs-target="#productscart"
            onclick="Javascript:showCartPage();">
    ...
    <div class="offcanvas offcanvas-end sidenav" tabindex="-1" id="productscart">
        <div class="container">
            ...
            <div class="w-100 mt-3">
                ...
                <div class="w-100 text-center text-white">NH7 , Pillayar Kovil opposite , Near Tollgate , Etturvattam ,
                    Sattur. </div>
                    ...
                    <table cellpadding="0" cellspacing="0" class="pricelist_table table card_products_table mb-0">
                        ...
                        <tbody id="demo">
                            <tr class="product_row">
                                ...
                                <td class="product_name text-left" style="width:100%">Ground Chakar asoka big (25pcs)
                                </td>
            ...
            <div class="enq-form">
                <form name="order_form">
                    ...
                    <div class="w-100 text-center my-2">
                        ...
                        <button class="btn btn-danger btnwidth" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#productscart">Back</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 py-2">
                    <div class="trebuchet text-center text-white">Copyright &copy; 2024, greepfireworks. <span
